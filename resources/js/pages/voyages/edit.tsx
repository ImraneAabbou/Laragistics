...
export default function Dashboard() {
    const { boats, ports, statuses, voyage } = usePage().props;

    const { data, setData, put, processing, errors } = useForm({
        ...voyage,
        departure_date: formatDate(voyage.departure_date), // Ensure date format is 'YYYY-MM-DD'
        arrival_date: formatDate(voyage.arrival_date), // Ensure date format is 'YYYY-MM-DD'
    });
    ...
    const handleSubmit = (e: React.FormEvent) => {
        e.preventDefault();
        put(route("voyages.update", { voyage: voyage.id }), {
            onSuccess: () => {
